...
@section('c_header_title', '后台用户管理 - 用户列表')
                    ...
                    <div class="card">
                        <div class="card-toolbar clearfix">
                            ...
                            <div class="toolbar-btn-action">
                                <a class="btn btn-primary m-r-5" href="{{ url('admin/user_manage/create') }}"><i class="mdi mdi-plus"></i> 新增</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-default" href="{{ url('admin/user_manage/' . $val->id . '/edit') }}" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        text: '确认',
                        action: function(){
                            $.post("{{ url('admin/user_manage') }}/"+id, {"_method": "delete", "_token": "{{ csrf_token() }}"}, function (res) {
                                if (res.status == 0) {
                                    $.confirm({
                                        title: '错误提示',
                                        content: res.msg,
