...
@section('c_header_title', '文章管理 - 编辑文章')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('admin/article/'.$art->id) }}" method="post" class="row">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="form-controls">
                                        <select name="cate_id" class="form-control" id="cate_id">
                                            ...
                                            @foreach($cate as $v)
                                                <option value="{{ $v->id }}" @if ($art->cate_id == $v->id) selected @endif>{{ str_repeat('|——', $v->level) }}{{ $v->cate_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="{{ $art->title }}" placeholder="请输入标题" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="seo_keywords">关键词</label>
                                    <input type="text" class="form-control" id="keywords" name="keywords" value="{{ $art->keywords }}" placeholder="关键词" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="seo_description">描述</label>
                                    <textarea class="form-control" id="description" name="description" rows="5" placeholder="描述">{{ $art->description }}</textarea>
                                </div>
                                <div class="form-group col-md-12">
                                    <label>多图上传</label>
                                    <div class="form-controls">
                                        <ul class="list-inline clearfix lyear-uploads-pic">
                                            @if (!empty($art->img_url))
                                                @foreach($art->img_url as $v)
                                                    <li class="col-xs-4 col-sm-3 col-md-2">
                                                        <figure>
                                                            <img src="{{ config('filesystems.disks.public.url') . '/' . $v }}" alt="">
                                                            <figcaption>
                                                                <input type="hidden" name="img_url[]" value="{{ $v }}">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="form-controls">
                                        <select name="label" class="form-control" id="label">
                                            ...
                                            @foreach($label as $v)
                                                <option value="{{ $v->id }}" @if ($art->label_id == $v->id) selected @endif>{{ $v->label_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="clearfix">
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="recommend" value="0" @if ($art->recommend != 1) checked @endif><span>否</span>
                                        </label>
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="recommend" value="1" @if ($art->recommend == 1) checked @endif><span>是</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="clearfix">
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="status" value="0" @if ($art->status != 1) checked @endif><span>未发布</span>
                                        </label>
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="status" value="1" @if ($art->status == 1) checked @endif><span>已发布</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
